  ...
  <nav class="border-gray-200 bg-white">
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
      <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center whitespace-nowrap text-2xl font-semibold">Flowbite</span>
      </a>
      <button
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        ...
        >
          ...
          <li>
            <a
              href="#"
              class="darder-0 block rounded px-3 py-2 text-gray-900 hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-blue-700"
            >
              About
            </a>
          </li>
